...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ServerStatus.server'
        db.delete_column(u'MegWorld_serverstatus', 'server')

        # Adding field 'ServerStatus.address'
        db.add_column(u'MegWorld_serverstatus', 'address',
                      self.gf('django.db.models.fields.CharField')(max_length=255, unique=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ServerStatus.server'
        db.add_column(u'MegWorld_serverstatus', 'server',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, unique=True),
                      keep_default=False)

        # Deleting field 'ServerStatus.address'
        db.delete_column(u'MegWorld_serverstatus', 'address')
    ...
    models = {
        ...
        u'MegWorld.serverstatus': {
            ...
            'address': ('django.db.models.fields.CharField', [], {'max_length': '255', 'unique': 'True', 'null': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
